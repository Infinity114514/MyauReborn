...
public class KillAura extends Module {
    ...
    private long getAttackDelay() {
        ...
        return this.isBlocking ? (long) (1000.0F / RandomUtil.nextLong(this.autoBlockMinCPS.getValue().longValue(), this.autoBlockMaxCPS.getValue().longValue()))
    ...
    public KillAura() {
        ...
        this.autoBlock = new ModeProperty(
                "auto-block", 2, new String[]{"NONE", "VANILLA", "SPOOF", "BLINKA", "BLINKB", "INTERACT", "SWAP", "LEGIT", "FAKE"}
        );
    ...
    public void verifyValue(String value) {
        ...
        if (!this.autoBlock.getName().equals(value)) {
            ...
            if (badCps && (this.autoBlockMinCPS.getValue() > 20.0F || this.autoBlockMaxCPS.getValue() > 20.0F)) {
                ...
                this.autoBlockMaxCPS.setValue(20.0F);
            }
        }
    }
