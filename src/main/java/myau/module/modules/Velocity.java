...
public class Velocity extends Module {
    ...
    private boolean ShouldJump = false; // Hypixel jump flag
    ...
    // Enabled knockback sliders for both Vanilla (0) and Jump (1) modes
    ...
    public void onKnockback(KnockbackEvent event) {
        ...
        if (!this.allowNext || !this.fakeCheck.getValue()) {
            ...
            if (this.pendingExplosion) {
                // Fixed: Apply explosion reduction to both Vanilla and Jump modes
                ...
                // Fixed: Apply chance, jump flag, and knockback reduction to both Vanilla and Jump modes
                if (this.mode.getValue() <= 1) {
    ...
    public String[] getSuffix() {
        if (this.mode.getValue() <= 1) { // Apply correct suffix logic to Mode 1
            return new String[]{
